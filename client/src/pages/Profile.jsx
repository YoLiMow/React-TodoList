...
export default function Profile() {
  ...
  return (
    <>
      {/* Header */}
      <Header isShowHome={true} isShowAbout={true} isShowDashboard={true} />
      <div className="p-3 max-w-lg mx-auto">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <input
            ...
            className="bg-input-bg border-border text-text rounded-lg p-3"
          ></input>
          <input
            type="email"
            id="email"
          ...
          <input
            ...
            className="bg-input-bg border-border text-text rounded-lg p-3"
          ></input>
          <button className="bg-text text-white p-3 rounded-lg uppercase hover:opacity-75 disabled:opacity-50">
        ...
        <p className="text-green-700 mt-5 text-center">
          {isUpdateSuccess && "Profile information correctly updated"}
        </p>
      </div>
    </>
  );
